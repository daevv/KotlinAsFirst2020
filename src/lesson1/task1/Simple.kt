 ...
 */
fun seconds(hours: Int, minutes: Int, seconds: Int): Int = seconds + (minutes + hours * 60) * 60
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    val hours = hoursArrive - hoursDepart
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val stonks = (100 + percent) / 100.0
    val year_1 = initial * stonks
    val year_2 = year_1 * stonks
    return year_2 * stonks
}
